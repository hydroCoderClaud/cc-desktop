...
This project is indexed by GitNexus as **cc-desktop** (6112 symbols, 16121 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
