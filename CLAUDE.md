...
This project is indexed by GitNexus as **cc-desktop** (6157 symbols, 16284 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
