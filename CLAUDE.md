...
This project is indexed by GitNexus as **cc-desktop** (5720 symbols, 15323 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
