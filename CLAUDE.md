...
This project is indexed by GitNexus as **cc-desktop** (6128 symbols, 16042 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
