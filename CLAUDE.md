...
- 相关核心文件：
  ...
  - `src/main/managers/skills/market.js`
...
This project is indexed by GitNexus as **cc-desktop** (6116 symbols, 16115 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
