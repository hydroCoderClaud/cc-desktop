...
This project is indexed by GitNexus as **cc-desktop** (5168 symbols, 13619 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
