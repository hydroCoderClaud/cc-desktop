...
This project is indexed by GitNexus as **cc-desktop** (2939 symbols, 8618 relationships, 231 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
