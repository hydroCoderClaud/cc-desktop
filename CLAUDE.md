...
This project is indexed by GitNexus as **cc-desktop** (6102 symbols, 15965 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
