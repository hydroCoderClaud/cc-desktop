...
export default {
  ...
  globalSettings: {
    ...
    marketMirrorUrl: 'Mirror URL',
    marketMirrorUrlPlaceholder: 'Enter mirror registry Raw URL (optional)',
    marketMirrorUrlHint: 'Auto-fallback when primary URL is unreachable, e.g. Gitee Raw URL',
