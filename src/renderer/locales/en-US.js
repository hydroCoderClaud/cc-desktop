...
export default {
  ...
  weixinNotify: {
    ...
    targetHint: 'Each notification recipient must scan the QR code themselves. After scanning, click "Capture Latest Message"; once a sendable target appears, test notification can be sent.',
    ...
    noTargets: 'No target is available yet. Ask the recipient to scan the authorization QR code, then capture latest messages.',
    ...
    loginNextStepTitle: 'Next: capture authorized target',
    loginNextStepContent: 'After the Weixin user authorizes by scanning, click "Capture Latest Message". Once a sendable target is captured, send a test notification.',
