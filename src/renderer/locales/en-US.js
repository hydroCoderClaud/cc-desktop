...
export default {
  ...
  rightPanel: {
    ...
    scheduledTasks: {
      ...
      modelTierPlaceholder: 'Select a model tier',
  ...
  providerManager: {
    ...
    needsMapping: 'Enable Tier Mapping',
    needsMappingWarn: '',
    needsMappingHint: 'Only fill this when you need compatibility with the sonnet / opus / haiku tier names',
