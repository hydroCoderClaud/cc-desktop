...
export default {
  ...
  sessionApps: {
    title: 'Session Apps',
    subtitle: 'Turn a polished Agent workflow into a reusable session-based app you can launch repeatedly.',
    appCount: '{count} total',
    definition: 'App Definition',
    currentDefinition: 'Current Definition',
    sessions: 'App Sessions',
    emptySessions: 'This app has no run history yet.',
    openSessionFailed: 'Failed to open app session',
    notConfigured: 'Not configured',
    deleteAppTitle: 'Delete Session App',
    deleteAppContent: 'Delete app "{name}"? Existing history conversations will remain.',
    deleteAppContentWithSessions: 'Delete app "{name}"? It currently has {count} linked conversations, so please delete with caution. Existing history conversations will remain.',
    deleteAppFailed: 'Failed to delete app',
    appDeleted: 'App deleted',
    newApp: 'New App',
    defaultDraftName: 'New Session App',
    untitled: 'Untitled',
    launch: 'Launch',
    duplicate: 'Duplicate',
    launchSuccess: 'Created a new Session App session',
    launchFailed: 'Failed to launch Session App',
    emptyApps: 'No Session Apps yet.',
    loadFailed: 'Failed to load Session Apps',
    createAppFailed: 'Failed to create app',
    appCreated: 'App created',
    saveAppFailed: 'Failed to save app',
    appSaved: 'App saved',
    duplicateAppFailed: 'Failed to duplicate app',
    appDuplicated: 'App duplicated',
    form: {
      name: 'App Name',
      namePlaceholder: 'For example: Weekly Report Assistant',
      description: 'Description',
      descriptionPlaceholder: 'Describe the goal, input pattern, and expected output of this Session App.',
      startupMessage: 'Startup Message Template',
      startupPlaceholder: 'Automatically sent as the first user message whenever a new app session starts.',
      systemPrompt: 'System Prompt',
      systemPromptPlaceholder: 'Optional. Constrain role, boundary, and execution style for this app.',
  ...
  channelSettings: {
    ...
    channels: {
      common: {
        ...
        description: 'Shared copy and presentation settings for all IM channels'
      },
      dingtalk: {
        label: 'DingTalk',
  ...
  weixinNotify: {
    ...
    disabledHint: 'When disabled, background polling and Weixin entry points stop, while authorized accounts and captured targets are preserved.',
    ...
    configSaved: 'Weixin notification settings saved',
    configSaveFailed: 'Failed to save Weixin notification settings',
    toggleFailed: 'Failed to toggle Weixin notification',
  ...
  profileManager: {
    ...
    fetchModelsSuccess: 'Fetched {count} model ID(s)',
    fetchModelsEmpty: 'The API returned no model IDs; the current list was kept',
    fetchModelsFailed: 'Failed to fetch model IDs',
  ...
  agent: {
    ...
    removeProject: 'Remove from project tree',
    removeProjectConfirmContent: 'The project and its history will be hidden. Its directory will not be deleted; opening the same directory restores it.',
    collapseOtherProjects: 'Collapse Other Projects',
    newConversationInProject: 'New Conversation Here',
    ...
    appFilterAll: 'All sessions',
    appFilterSessionApps: 'Session Apps',
    appFilterPlainSessions: 'Plain sessions',
    sessionAppBadge: 'App',
    apiProfile: 'API Profile',
    ...
    cmdSessionApp: 'Create a Session App setup card in chat',
    cmdSchedule: 'Create a scheduled task draft in chat and confirm it before saving',
    sessionAppDraftTitle: 'Create Session App',
    sessionAppDraftHintWithPrompt: 'Confirm the Session App configuration below. You can save it directly, or launch an app session immediately after creation.',
    sessionAppDraftHintEmpty: 'No clear app goal was extracted yet. Fill in the app description, startup message, and working boundary first.',
    sessionAppDraftStatusConfirmed: 'Created',
    sessionAppDraftConfirmed: 'Session App "{name}" has been created',
    sessionAppDraftLaunchCreated: 'Created app session: {title}',
    sessionAppDraftCreatedToast: 'Session App "{name}" created',
    sessionAppDraftPublishAction: 'Create',
    sessionAppDraftNameRequired: 'Session App name is required',
    sessionAppDraftApiUnavailable: 'Session App API unavailable',
    sessionAppDraftNotFound: 'Session App card not found',
    sessionAppDraftCreateFailed: 'Failed to create Session App',
    sessionAppDraftWorkingDirectory: 'Default working directory',
    sessionAppDraftAfterPublish: 'After create',
    sessionAppDraftAfterPublishSave: 'Save to Session Apps only',
    sessionAppDraftAfterPublishLaunch: 'Create app session now',
    ...
    imQuickUnbindTitle: 'Unbind IM Target',
    imQuickUnbindConfirm: 'This session will become a normal session again and lose the current IM binding. Continue?',
    imQuickUnbindFailed: 'Failed to unbind IM target',
  ...
  notebook: {
    ...
    loadFailed: 'Failed to open notebook: {error}',
