...
export default {
  ...
  agent: {
    ...
    enterpriseWeixinQuickSendHint: 'Choose a WeCom member. The message is sent from this session, and replies return here.',
    ...
    enterpriseWeixinNoTargets: 'No sendable WeCom targets. Check contact access or refresh the target list first.',
