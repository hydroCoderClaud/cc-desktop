...
export default {
  ...
  globalSettings: {
    ...
    developerRuntimeGroup: 'Claude Runtime',
    ...
    developerClaudeSourceHint: 'Controls whether Agent sessions launch Claude from the bundled binary or the system claude command.',
