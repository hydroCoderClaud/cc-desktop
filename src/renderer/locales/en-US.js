...
export default {
  ...
  rightPanel: {
    ...
    scheduledTasks: {
      ...
      maxTurns: 'Max Turns',
      maxTurnsPlaceholder: 'Leave empty for unlimited',
      ...
      firstRunMode: 'First Trigger',
      firstRunModePlaceholder: 'Select first trigger mode',
      firstRunModeImmediate: 'Run immediately once',
      firstRunModeNextSlot: 'Wait for next slot',
      firstRunModeCustom: 'Choose first time',
      firstRunAt: 'First Run At',
      firstRunAtPlaceholder: 'Select date and time',
      firstRunAtRequired: 'Please select the first run time',
      nextRun: 'Next Run',
      lastRun: 'Last Run',
      ...
      firstRunImmediateDesc: 'Run immediately once, then {schedule}',
      firstRunCustomDesc: 'First run at {time}, then {schedule}',
  ...
  weixinNotify: {
    tab: 'Weixin Notify',
    title: 'Weixin Notify',
    subtitle: 'Scheduled tasks can proactively notify bound Weixin targets.',
    boundary: 'This uses Hydro Desktop built-in iLink calls and does not depend on OpenClaw. It only supports users who scanned the QR code and sent a message to the bot; it does not read contacts.',
    loginTitle: 'Sender Account Binding',
    startLogin: 'Generate QR Code',
    captureTarget: 'Capture Latest Message',
    qrAlt: 'Weixin login QR code',
    scanHint: 'Scan the QR code with Weixin and confirm authorization.',
    targetHint: 'Scanning only binds the sender account and does not create a notification target. After binding, ask the recipient to message the bot, then capture the latest message.',
    noAccounts: 'No Weixin account is bound yet',
    accountListHint: 'This list shows QR-authorized sender accounts, not captured notification targets. Targets must come from messages sent to the bot.',
    sendTitle: 'Send Test',
    target: 'Target',
    ...
    noTargets: 'No target is available yet. Ask the target user to message the bot first.',
    ...
    loginNextStepTitle: 'Next: ask the target user to message the bot',
    loginNextStepContent: 'Scanning only binds the sender account and does not automatically capture a notification target. Ask the recipient to send one message to this bot, then click "Capture Latest Message".',
  ...
  agent: {
    ...
    scheduleDraftFirstRunAt: 'First run: {time}',
