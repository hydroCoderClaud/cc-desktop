...
export default {
  ...
  weixinNotify: {
    ...
    boundary: 'This uses Hydro Desktop built-in iLink calls. It only supports users who scanned the QR code and sent a message to the bot; it does not read contacts.',
    ...
    accountListHint: 'This list shows QR-authorized sender accounts, not notification targets.',
    sendTitle: 'Send Test',
    target: 'Target',
