...
export default {
  ...
  agent: {
    ...
    scheduleDraftHintWithPrompt: 'Review the task draft below. It will only be created after you confirm.',
    ...
    scheduleDraftCreated: 'Scheduled task "{name}" has been created',
