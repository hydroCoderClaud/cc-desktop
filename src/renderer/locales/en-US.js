...
export default {
  ...
  agent: {
    ...
    enterpriseWeixinQuickSendHint: 'The message is sent to the WeCom contact already bound to this session, and replies return here.',
    ...
    enterpriseWeixinNoTargets: 'This session is not bound to a WeCom contact yet.',
