...
export default {
  ...
  rightPanel: {
    ...
    scheduledTasks: {
      ...
      firstRunMode: '首次触发',
      firstRunModePlaceholder: '选择首次触发方式',
      firstRunModeImmediate: '立即执行一次',
      firstRunModeNextSlot: '等待下个周期',
      firstRunModeCustom: '指定首次时间',
      firstRunAt: '首次执行时间',
      firstRunAtPlaceholder: '选择日期和时间',
      firstRunAtRequired: '请选择首次执行时间',
      nextRun: '下次执行',
      lastRun: '上次执行',
      failureCount: '失败次数',
      basicInfo: '任务信息',
      ...
      firstRunImmediateDesc: '立即执行一次，之后{schedule}',
      firstRunCustomDesc: '首次于 {time} 执行，之后{schedule}',
      runStatusSuccess: '成功',
      runStatusFailed: '失败',
      runStatusSkipped: '跳过',
  ...
  weixinNotify: {
    tab: '微信通知',
    title: '微信通知',
    subtitle: '绑定微信目标后，定时任务可以主动发送通知。',
    boundary: '该能力使用 Hydro Desktop 内建 iLink 通道，不依赖 OpenClaw；仅支持已扫码授权且主动发过消息的微信目标，不读取通讯录。',
    loginTitle: '发送账号绑定',
    startLogin: '生成扫码二维码',
    captureTarget: '捕获最新消息',
    qrAlt: '微信登录二维码',
    scanHint: '请使用微信扫描二维码并确认授权。',
    targetHint: '扫码只绑定发送账号，不会创建通知目标。绑定后必须让接收人先给 bot 发一条消息，再点击“捕获最新消息”。',
    noAccounts: '暂无已绑定微信账号',
    accountListHint: '这里显示的是扫码授权的发送账号，不是已捕获通知目标。目标必须来自对方发给 bot 的消息。',
    sendTitle: '发送测试',
    target: '通知目标',
    ...
    ready: '可发送',
    needsMessage: '缺少上下文',
    noTargets: '暂无可通知目标。请先让目标用户发一条消息给 bot。',
    refreshFailed: '刷新微信通知状态失败',
    loginStartFailed: '二维码生成失败',
    loginSuccess: '微信账号已绑定',
    loginNextStepTitle: '下一步：让目标用户发消息',
    loginNextStepContent: '扫码只完成发送账号绑定，不会自动捕获通知目标。请让接收人给该 bot 发送一条消息，然后点击“捕获最新消息”。',
    loginFailed: '微信登录失败',
  ...
  agent: {
    ...
    scheduleDraftFirstRunAt: '首次执行时间：{time}',
