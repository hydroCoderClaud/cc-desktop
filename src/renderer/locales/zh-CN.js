...
export default {
  ...
  weixinNotify: {
    ...
    targetHint: '每个需要接收通知的人都要自己扫码授权。扫码后点击“捕获最新消息”，出现可发送目标后即可测试通知。',
    ...
    ready: '可发送',
    needsMessage: '缺少上下文',
    noTargets: '暂无可通知目标。请先让接收通知的人扫码授权，然后点击“捕获最新消息”。',
    refreshFailed: '刷新微信通知状态失败',
    loginStartFailed: '二维码生成失败',
    loginSuccess: '微信账号已绑定',
    loginNextStepTitle: '下一步：捕获授权目标',
    loginNextStepContent: '扫码完成微信用户授权后，请点击“捕获最新消息”。捕获到可发送目标后，就可以发送测试通知。',
    loginFailed: '微信登录失败',
