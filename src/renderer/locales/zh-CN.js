...
export default {
  ...
  rightPanel: {
    ...
    scheduledTasks: {
      ...
      createTaskHint: '填写任务内容与调度规则，保存后会按计划自动执行。',
      taskCount: '共 {count} 个任务',
      selectAll: '全选任务',
      selectedCount: '已选择 {count} 项',
      batchDelete: '批量删除',
      batchDeleteConfirmTitle: '批量删除定时任务',
      batchDeleteConfirmContent: '确定删除选中的 {count} 个任务吗？它们的历史记录也会一起删除。',
      statusAll: '全部状态',
      enabled: '启用',
      disabled: '停用',
      createTask: '新建定时任务',
  ...
  sessionApps: {
    title: '会话应用',
    subtitle: '把已经打磨好的 Agent 工作流沉淀成可反复启动的会话型应用。',
    appCount: '共 {count} 个',
    definition: '应用定义',
    currentDefinition: '当前定义',
    sessions: '关联会话',
    emptySessions: '这个应用还没有运行历史。',
    openSessionFailed: '打开应用会话失败',
    notConfigured: '未设置',
    deleteAppTitle: '删除会话应用',
    deleteAppContent: '确认删除应用“{name}”？不会删除已经产生的历史会话。',
    deleteAppContentWithSessions: '确认删除应用“{name}”？当前有关联会话 {count} 个，请慎重删除。不会删除已经产生的历史会话。',
    deleteAppFailed: '删除应用失败',
    appDeleted: '应用已删除',
    newApp: '新建应用',
    defaultDraftName: '新会话应用',
    untitled: '未命名',
    launch: '启动',
    duplicate: '复制',
    launchSuccess: '已创建新的应用会话',
    launchFailed: '启动会话应用失败',
    emptyApps: '还没有会话应用。',
    loadFailed: '加载会话应用失败',
    ...
    appSaved: '应用已保存',
    duplicateAppFailed: '复制应用失败',
    appDuplicated: '应用已复制',
    form: {
      name: '应用名称',
      namePlaceholder: '例如：周报助手',
      description: '应用说明',
      descriptionPlaceholder: '说明这个会话应用的目标、输入方式和预期产出。',
      startupMessage: '启动消息模板',
      startupPlaceholder: '每次新建应用会话时，自动发送给 Agent 的首条提示。',
      systemPrompt: '系统提示词',
      systemPromptPlaceholder: '可选。用于约束这类会话的角色、边界与执行方式。',
      defaultCwd: '默认工作目录'
    }
  },
  ...
  channelSettings: {
    ...
    channels: {
      common: {
        label: '公共设置',
        description: '所有 IM 渠道共用的文案和展示配置'
      },
      dingtalk: {
        label: '钉钉',
  ...
  weixinNotify: {
    ...
    enableBridge: '启用微信通知',
    disabledHint: '关闭后将停止后台轮询与微信入口显示，但已授权账号和目标仍会保留。',
    ...
    configSaved: '微信通知配置已保存',
    configSaveFailed: '保存微信通知配置失败',
    toggleFailed: '切换微信通知状态失败',
  ...
  profileManager: {
    ...
    fetchModelsSuccess: '已获取 {count} 个模型 ID',
    fetchModelsEmpty: '接口未返回模型 ID，已保留当前列表',
  ...
  agent: {
    ...
    pinProject: '置顶项目',
    unpinProject: '取消置顶项目',
    removeProject: '从项目树移除',
    removeProjectConfirmContent: '项目及其历史会话将不再显示，不会删除磁盘目录。重新打开该目录即可恢复。',
    collapseOtherProjects: '折叠其他项目',
    newConversationInProject: '在此项目新建对话',
    ...
    sourceWeixin: '微信',
    sourceFeishu: '飞书',
    sourceEnterpriseWeixin: '企业微信',
    filterDirectory: '目录',
    filterIm: 'IM',
    filterTask: '定时任务',
    filterApp: '应用',
    taskFilterPlaceholder: '定时任务筛选',
    taskFilterAll: '全部',
    taskFilterWithTask: '有定时任务',
    taskFilterWithoutTask: '无定时任务',
    appFilterAll: '全部会话',
    ...
    cmdHelp: '显示帮助信息',
    cmdClear: '清除对话历史',
    cmdSessionApp: '在聊天中创建一个会话应用配置卡片',
    cmdSchedule: '在聊天中创建一个待确认的定时任务草案',
    sessionAppDraftTitle: '创建会话应用',
    sessionAppDraftHintWithPrompt: '请确认下面的会话应用配置。创建后可直接保存，或立即启动一个应用会话。',
    sessionAppDraftHintEmpty: '还没有提炼出明确应用目标，你可以先补充应用说明、启动消息和工作边界。',
    sessionAppDraftStatusConfirmed: '已创建',
    sessionAppDraftConfirmed: '已创建会话应用“{name}”',
    sessionAppDraftLaunchCreated: '已创建应用会话：{title}',
    sessionAppDraftCreatedToast: '会话应用“{name}”已创建',
    sessionAppDraftPublishAction: '创建',
    sessionAppDraftNameRequired: '请输入会话应用名称',
    sessionAppDraftApiUnavailable: '会话应用接口不可用',
    sessionAppDraftNotFound: '未找到会话应用卡片',
    sessionAppDraftCreateFailed: '创建会话应用失败',
    sessionAppDraftWorkingDirectory: '默认工作目录',
    sessionAppDraftAfterPublish: '创建后操作',
    sessionAppDraftAfterPublishSave: '仅保存到会话应用',
    sessionAppDraftAfterPublishLaunch: '立即创建应用会话',
    ...
    scheduleDraftSessionBindingLabel: '会话绑定',
    scheduleDraftSessionBindingCurrent: '当前会话',
    scheduleDraftSessionBindingNew: '新建会话',
    ...
    enterpriseWeixinObserving: '企业微信观察模式 — 来自企业微信的消息将实时显示',
    dingtalkQuickSendTitle: '发送钉钉消息',
    dingtalkQuickSendHint: '选择钉钉组织成员，消息会从当前会话发出，回复会回到当前会话。',
    dingtalkQuickSendPlaceholder: '输入要发送到钉钉的内容',
    dingtalkQuickSend: '发送钉钉',
    dingtalkQuickSending: '发送中...',
    dingtalkQuickSendFailed: '钉钉发送失败',
    dingtalkNoTargets: '暂无可发送钉钉目标，请检查钉钉通讯录权限或机器人配置',
    ...
    feishuQuickSendTitle: '发送飞书消息',
    feishuQuickSendHint: '选择飞书组织成员，消息会从当前会话发出，回复会回到当前会话。',
    feishuQuickSendPlaceholder: '输入要发送到飞书的内容',
    feishuQuickSend: '发送飞书',
    feishuQuickSending: '发送中...',
    feishuQuickSendFailed: '飞书发送失败',
    feishuNoTargets: '暂无可发送飞书目标，请先开通通讯录权限或刷新目标列表',
    enterpriseWeixinQuickSendTitle: '发送企业微信消息',
    enterpriseWeixinQuickSendHint: '未绑定时先读取联系人并选择目标；绑定后，该会话会固定发送给这个企业微信联系人。',
    enterpriseWeixinQuickSendPlaceholder: '输入要发送到企业微信的内容',
    enterpriseWeixinQuickSend: '发送企业微信',
    ...
    imQuickUnbind: '解除绑定',
    imQuickUnbindTitle: '解除 IM 绑定',
    imQuickUnbindConfirm: '解除后，该会话将恢复为普通会话，不再保留当前 IM 绑定关系。是否继续？',
    imQuickUnbindFailed: '解除绑定失败',
  ...
  dingtalkSettings: {
    ...
    robotCode: '机器人 Code',
    robotCodePlaceholder: '请输入钉钉机器人的 robotCode',
    robotCodeHint: '用于桌面端主动向钉钉成员发送消息，可在机器人或消息推送配置中获取',
    defaultCwd: '默认工作目录',
